    ...
    <div className='border border-input border-t-0 border-x-0 rounded-t-lg p-2 bg-card flex flex-wrap gap-1 items-center'>
     <TooltipProvider>
      <div className='flex flex-wrap gap-1 items-center'>
        ...
        <Tooltip>
            <TooltipTrigger asChild> 
             <Toggle size="sm" pressed={editor.isActive('heading1', {level:1})} onPressedChange={() => editor.chain().focus().toggleHeading({ level: 1 }).run()}
              className={cn(editor.isActive('heading1 ') && 'bg-muted text-muted-foreground')}
              >
              <Heading1Icon />
             </Toggle>
                </TooltipTrigger>
        ...
        <Tooltip>
            <TooltipTrigger asChild> 
             <Toggle size="sm" pressed={editor.isActive('heading2', {level: 2})} onPressedChange={() => editor.chain().focus().toggleHeading({ level: 2 }).run()}
              className={cn(editor.isActive('heading2 ') && 'bg-muted text-muted-foreground')}
              >
              <Heading2Icon />
             </Toggle>
                </TooltipTrigger>
        ...
        <Tooltip>
            <TooltipTrigger asChild> 
             <Toggle size="sm" pressed={editor.isActive('heading3', {level:3})} onPressedChange={() => editor.chain().focus().toggleHeading({ level: 3 }).run()}
              className={cn(editor.isActive('heading3 ') && 'bg-muted text-muted-foreground')}
              >
              <Heading3Icon  />
             </Toggle>
                </TooltipTrigger>
