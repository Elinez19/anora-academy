...
export default function GitHubCallbackPage() {
  ...
  if (status === 'loading') {
    return (
      <div className="text-center space-y-4">
        ...
        <p className="text-midnight-600">Please wait while we complete your GitHub sign-in</p>
      </div>
    );
  }
  ...
  return (
    <div className="text-center space-y-4">
      ...
      <p className="text-midnight-600">You have successfully signed in with GitHub</p>
